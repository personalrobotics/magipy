...
class RestartPlanner(Planner):
    ...
    def plan_action(self, env, action, output_queue=None):
        if output_queue is not None:
            logger.warning('RestartPlanner does not support parallel planning and execution -- output_queue only used at end.')
        ...
        while i < attempts:
            ...
            try:
                ...
                logger.warning('Attempt %d of %d failed, restarting from top.', i, attempts)
